...
public class IntegracionTest {
    ...
    public void testCasoExitoso() {
        ...
        boolean resultado = Servicio.verificarLimite(total);
    ...
    public void testErrorEnFuncionBase() {
    ...
    public void testErrorEnFuncionSecundaria() {
        List<Producto> productos = List.of(
        ...
        double total = Pedido.calcularTotalPedido(productos, descuento);
        boolean dentroLimite = Servicio.verificarLimite(total);
    ...
    public void testCombinacionDeValidaciones() {
        List<Producto> productos = List.of(
        ...
        boolean stockValido = Servicio.verificarStock(productos);
        boolean descuentoValido = Servicio.validarDescuento(descuento);
        boolean clienteValido = Servicio.validarCliente(cliente);

        double total = Pedido.calcularTotalPedido(productos, descuento);
        boolean dentroLimite = Servicio.verificarLimite(total);
        double totalConIGV = Servicio.calcularIGV(total);
