...
public class ServicioTest {
    ...
    void testValidarDescuentoValido() {
        ...
        boolean resultado = Servicio.validarDescuento(descuento);
        assertTrue(resultado);
    }
    ...
    void testCalcularIGV() {
        double total = 200.0;
        double resultado = Servicio.calcularIGV(total);
    ...
    void testValidarClienteValido() {
        ...
        boolean resultado = Servicio.validarCliente(nombre);
        assertTrue(resultado);
    }
    ...
    void testVerificarStockValido() {
        ...
        boolean resultado = Servicio.verificarStock(productos);
        assertTrue(resultado);
    }
